...
class StripeInvoicesToPostgresOperator(DagRunTaskCommsMixin, BaseOperator):
    @apply_defaults
    def __init__(
        self,
        postgres_conn_id,
        ...
        **kwargs,
        ...
        self.last_successful_invoice_key = "last_successful_invoice_id"
        self.separator = "__"
...
"""
    ...
    def execute(self, context):
        ...
        with engine.connect() as conn:
            ...
            starting_after = self.get_last_successful_invoice_id(conn, context)
            extra_context = {
                **context,
                **self.context,
            ...
            while has_more:
                ...
                self.set_last_successful_invoice_id(conn, context, starting_after)
...
"""
    ...
    def set_last_successful_invoice_id(self, conn, context, starting_after):
        return self.set_task_var(conn, context, self.last_successful_invoice_key, starting_after)

    def get_last_successful_invoice_id(self, conn, context):
        return self.get_task_var(conn, context, self.last_successful_invoice_key)
